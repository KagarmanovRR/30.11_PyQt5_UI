...
class Ui_widget(object):
    def setupUi(self, widget):
        ...
        self.tableWidget.setGeometry(QtCore.QRect(10, 270, 511, 192))
        ...
        self.spKurs = QtWidgets.QSpinBox(self.widget)
        self.spKurs.setObjectName("spKurs")
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.FieldRole, self.spKurs)
